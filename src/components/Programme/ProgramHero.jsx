...
import heroBg from "../../assets/images/p-hero-bg.png";
          ...
          <div className="relative w-full min-h-[520px] sm:min-h-[640px] md:min-h-[700px] lg:min-h-[calc(100vh-120px)] flex items-center justify-center px-3 pt-2 pb-8 sm:px-6 sm:py-10 lg:px-10 lg:py-0">
            <div className="relative w-full max-w-[430px] min-[480px]:max-w-[560px] sm:max-w-[720px] md:max-w-[900px] lg:max-w-[1050px] aspect-[829/691] sm:aspect-[829/620] md:aspect-[16/9] lg:aspect-[16/8] flex items-center justify-center">
              ...
              <img
                ...
                className="absolute  w-auto h-auto object-contain object-center select-none pointer-events-none"
              />
              ...
              <img
                src={arrowImg}
                alt=""
                className="absolute left-[5%] bottom-[9%] w-[38px] min-[480px]:w-[48px] sm:left-[5%] sm:bottom-[7%] sm:w-[62px] md:w-[78px] lg:left-[5%] lg:bottom-[5%] lg:w-[85px] animate-float-reverse select-none pointer-events-none"
              />
              ...
              <div className="absolute left-[8%] top-[22%] z-20 max-w-[260px] min-[480px]:left-[9%] min-[480px]:top-[21%] min-[480px]:max-w-[330px] sm:left-[12%] sm:top-[19%] sm:max-w-[430px] md:left-[10%] md:top-[18%] md:max-w-[520px] lg:left-[10%] lg:top-[20%] lg:max-w-[640px]">
                <h1 className="hero-title-font">
                  ...
                  <span className="block hero-right-animate hero-delay-3 text-[#007BFF] text-[30px] min-[380px]:text-[34px] min-[480px]:text-[42px] sm:text-[48px] md:text-[56px] lg:text-[60px]">
                    Smart Students
                  </span>
                </h1>
    
                <p className="mt-2 max-w-[220px] text-[12px] leading-[1.25] text-black min-[480px]:max-w-[280px] min-[480px]:text-[12px] sm:mt-4 sm:max-w-[430px] sm:text-[16px] md:text-[18px] lg:max-w-[480px] animate-fade-up-delay">
