            ...
            >
              {partnerCards.map((card, index) => (
                <div
                  ...
                  w-[calc(50%-9px)] min-w-[calc(50%-9px)]
                ...
                >
                  <img
                    src={card.image}
                    alt={card.title}
                    className="w-[95px] h-[72px] object-cover rounded-[7px] mb-4"
                  />

                  <h2
                    className={`font-heading font-extrabold ${card.titleColor} text-[15px] sm:text-[18px] leading-tight`}
                  >
                    {card.title}
                  </h2>

                  <p className="mt-1 text-black font-bold text-[10px] sm:text-[15px]">
                    {card.subtitle}
                  </p>

                  <p className="mt-4 text-black/70 text-[11px] sm:text-[15px] leading-[18px] text-left">
                    {card.description}{" "}
                    <span className={`${card.linkColor} font-semibold`}>
                      Read More
                    </span>
                  </p>
                </div>
